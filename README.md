...
En movil, mejor en horizontal: el joystick izquierdo mueve y arrastrar la derecha apunta. Mirar, tocar o mantener la zona derecha **no dispara**. Mantener cualquiera de los botones FIRE dispara hasta soltarlo; sus dedos son independientes del movimiento y la mirada. El FIRE izquierdo permite usar un indice mientras ambos pulgares mueven y apuntan. JUMP salta; ◀ / ▶ recorren todas las armas disponibles, BAJAR mantiene el agachado y USAR activa el objeto seleccionado. Todos los botones tienen al menos 44 x 44 px y muestran la pulsacion.

El HUD movil muestra **salud, municion y armadura reales**, leidas del estado del jugador del servidor local del motor, con numeros de 26 px, fondo oscuro y aviso de salud baja. El blaster indica municion ilimitada (∞), y la armadura sin equipar indica 0. La mira central blanca tiene contorno oscuro. El HUD ocupa una franja propia encima de los controles y respeta las zonas seguras. El escritorio conserva el HUD original del motor.
